---
title: 'Chattr ChatGPT App Guide: A quick start on how to get started using chattr'
publishedAt: '2023-02-09'
summary: 'In this tutorial, we go over how to get started with chattr, a customizable chatgpt chatbot component library for Nextjs.'
---


# Chattr ChatGPT App Guide: A quick start on how to get started using chattr

Chattr is a customizable chatgpt chatbot component library for Nextjs. It's built with React, Tailwind CSS, and OpenAI's GPT models. Chattr is a great way to add a chatbot to your website or application. It's easy to use, highly customizable, and comes with two themes- `Default` and `Minimalist`. Lets jump in!
...
Chattr is a great way to add a chatbot to your website or application. It's easy to use, highly customizable, and comes with two themes- `Default` and `Minimalist`. You can use it to create a chatbot that can respond to user queries, provide information, and even generate images and videos. Chattr is an easy tool that can help you create engaging and interactive experiences for your users. Give it a try and see how it can enhance your website or application!
If you have any questions, feel free to reach out to me on [X](https://twitter.com/cbmonx). I'm always happy to help. Enjoy!
```