    ...
    <div className={`flex flex-col ${center ? "items-center" : "items-start"} p-8 sm:p-16`}>
      ...
      {date && (
        <time
          ...
          className="order-first mb-4 relative inline-flex overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50"
        >
          <span className="absolute inset-[-1000%] animate-[spin_10s_linear_alternate_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#3b82f6_0%,#262626_50%,#3b82f6_100%)]" />
          <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-gray-950 px-3 py-1 text-sm font-medium text-neural-200 backdrop-blur-3xl">
            {date}
          </span>
        </time>
      )}
