...
export default function Footer() {
  return (
    <footer className="relative bottom-0 left-0 flex-none pt-32" aria-label="Footer">
          ...
          <div className="relative px-4 sm:px-8 lg:px-12">
            <div className="mx-auto max-w-2xl lg:max-w-5xl">
              <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
                <ul
                  className="flex flex-wrap justify-center gap-x-6 gap-y-1 text-sm font-medium text-neutral-800 dark:text-neutral-200"
