  ...
  return (
    <ul>
      <li>
        ...
        >
          <XIcon className="size-6 transition text-neutral-200 hover:text-neutral-300" />
      ...
      <li className="mt-4 flex">
        ...
        >
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
            className="size-6 flex-none fill-neutral-500 transition group-hover:fill-blue-500"
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
